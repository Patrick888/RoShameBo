...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = rowDictionary["Result"]
        cell.detailTextLabel?.text = detailText
        cell.imageView?.image = UIImage(named: rowDictionary["Result"]!)
//        cell.textLabel?.text = String(describing: rowDictionary)
//        let testreult = String(describing: rowDictionary)
        print("tableView cellForRow got called, the rowDictionary is \(rowDictionary) ")
